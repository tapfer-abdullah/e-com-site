          ...
          <div className="space-y-3 w-4/5 mx-auto bg-white p-5 rounded-xl shadow-xl">
            ...
            <div className="grid grid-cols-1 gap-3">
              <div className="card">
                ...
                <button disabled={images?.length == 0} onClick={handleUploadPhoto} className="!font-semibold hover:bg-opacity-80">
                  Upload
                </button>
              </div>
              ...
              <div className="card2 max-h-[400px] overflow-y-auto">
                {imageURL.length != 0 ? (
                  <h4 className="text-center text-lg font-semibold text-[#0086fe]">Enter photo wise color & size wise SKU:</h4>
                ) : (
