    ...
    <div className="p-5">
      <div className="mb-5 flex justify-between items-center px-3 py-2 bg-[#d5ddda] shadow-lg rounded-lg">
        <Link href={"/dashboard/theme/pages"} className="text-xl font-semibold">
          Pages <span>({pagesData?.length})</span>
        </Link>
      ...
      <div>
        ...
        {pagesData?.length > 0 &&
          pagesData?.map((page) => (
            <div key={page?._id} className="bg-white my-3 py-2 px-4 border-2 rounded-lg shadow-md flex justify-between items-center">
              ...
              <div className="flex gap-2 items-center">
                {page?.url?.split("/").filter(Boolean)?.length < 2 ? (
                  <Link
                    href={`/dashboard/theme/pages${page?.url}`}
                    target="_blank"
                    className="px-4 py-1 font-semibold bg-gray-300 hover:bg-gray-400 flex items-center gap-1 border-2 rounded-3xl transition-all duration-300"
                  >
                ...
                <button
                  ...
                  className="py-2 px-4 font-semibold text-white bg-red-500 hover:bg-red-600 flex items-center gap-1 border-2 rounded-3xl transition-all duration-300"
                >
