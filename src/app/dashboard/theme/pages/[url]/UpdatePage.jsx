    ...
    <div className="p-5">
      <div className="mb-5 flex justify-between items-center px-3 py-2 bg-[#d5ddda] shadow-lg rounded-lg">
        <div className="flex items-center gap-2">
          <Link href={"/dashboard/theme/pages"} className="text-xl font-semibold">
            Pages
          </Link>
          <IoIosArrowForward />
              ...
              <div className="col-span-2 space-y-2">
                <div>
                  ...
                  <input
                    ...
                    name="title"
                    id="title"
                    className="w-full outline-1 outline-[#d5ddda] border-2 rounded-md px-2 py-1"
                  />
                </div>
                <div>
                  <p>Content</p>
              ...
              <div className="flex flex-col items-center gap-1 space-y-2 rounded-lg bg-[#def1e7] p-5 mt-6">
                <div className="w-full">
                  ...
                  <select
                    ...
                    name="visibility"
                    id="visibility"
                    className="w-full border-2 rounded-md px-2 py-[6px] outline-1 outline-[#d5ddda]"
                  >
                ...
                <div className="w-full">
                  <label>
                    Position * <small className="text-sm">(Header or footer)</small>
                  </label>
                  <select
                    value={position}
                    onChange={(e) => {
                ...
                {position == "Footer" && (
                  <div className="w-full">
                    <label>
                      Which column * <small className="text-sm">(in footer)</small>
                    </label>
                    <select
                      value={column}
                      onChange={(e) => {
