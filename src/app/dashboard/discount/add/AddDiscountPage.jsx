...
const AddDiscountPage = () => {
  ...
  const handleSave = () => {
    ...
    axiosHttp
      .post(`/discount`, discountCodeData)
      .then((res) => {
        // console.log(res.data)
        if (res.data.status) {
          Swal.fire({
        ...
        <>
          ...
          <div className="space-y-5 w-4/5 mx-auto">
            ...
            <div className="bg-white p-5 rounded-xl border border-[#d5ddda] shadow-md flex flex-col justify-center items-center">
              ...
              <RadioGroup onChange={(e) => setDiscountOn(e.target.value)} row aria-labelledby="demo-row-radio-buttons-group-label" name="row-radio-buttons-group">
              ...
              <div className="bg-white p-5 rounded-xl border border-[#d5ddda] shadow-md space-y-2">
                ...
                <div className="w-full flex justify-center items-center gap-2">
                  <DatePicker
                    ...
                    label="Start date"
                    className="w-full"
                    defaultValue={dayjs(defaultDateTime)}
                  />
                  <TimePicker
                    label="Start time (+06)"
                    className="w-full"
