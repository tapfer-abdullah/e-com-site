...
const IDwiseDiscountPage = () => {
  ...
  useEffect(() => {
    axiosHttp.get(`/discount/${resultArray?.[2]}`).then((res) => {
      ...
      setDisCategoryOption({
        value: oldDataAOffP?.DiscountedType?.option || oldDataAOffO?.DiscountedType?.option,
        label: oldDataAOffP?.DiscountedType?.option || oldDataAOffO?.DiscountedType?.option,
      });
  ...
  const handleSave = () => {
    ...
    let commonData = {
      ...
      limitDisOnePerUse: limitDisOnePerUse,
      isEndTime: isEndTime,
      startDate,
      startTime,
      EndDate,
    ...
    let BxGyData = {
      BxGyType,
      CusBuyAmount: BxGyCusBuyAmount,
      CusGetAmount: BxGyCusGetAmount,
    ...
    axiosHttp
      .put(`/discount/${resultArray[2]}`, discountCodeData)
      .then((res) => {
        ...
        <>
          <div className="mb-5 flex justify-between items-center px-3 py-2 bg-[#d5ddda] shadow-lg rounded-lg">
            <div className="flex items-center gap-2">
              <Link href={"/dashboard/discount"} className="text-xl font-semibold">
                All Discount Codes
              </Link>
              <IoIosArrowForward />
            ...
            <div className="flex items-center gap-2">
              <button
                onClick={() => {
                  handleDelete(oldDisData?._id);
                }}
                className="py-2 px-4 font-semibold text-white bg-red-500 hover:bg-opacity-80 flex items-center gap-1 border-2 border-red-500 rounded-lg transition-all duration-300"
              >
              ...
              <button
                ...
                className={`flex gap-2 items-center bg-[#FFC520] ${title?.length == 0 ? "opacity-50" : "hover:bg-opacity-80"} py-2 px-4 rounded-lg font-semibold cursor-pointer`}
              >
                Discard
              </button>
              <button
                disabled={title?.length == 0}
                onClick={handleSave}
                className={`flex gap-2 items-center bg-green-500 ${title?.length == 0 ? "opacity-50" : "hover:bg-opacity-80"} py-2 px-4 rounded-lg font-semibold cursor-pointer`}
              >
                Save
              </button>
            </div>
          ...
          <div className="space-y-5 w-4/5 mx-auto">
            ...
            <div className="bg-white p-5 rounded-xl border border-[#d5ddda] shadow-md flex flex-col justify-center items-center">
              ...
              <RadioGroup defaultValue={discountOn} onChange={(e) => setDiscountOn(e.target.value)} row aria-labelledby="demo-row-radio-buttons-group-label" name="row-radio-buttons-group">
          ...
          {discountOn && (
            <div className="mt-5 space-y-5 w-4/5 mx-auto">
              {/* Title & status */}
              <div className="bg-white p-5 rounded-xl border border-[#d5ddda] shadow-md flex items-center gap-2">
                <div className="w-full space-y-1 md:max-w-full lg:max-w-md">
                  ...
                  <input
                    ...
                    name="name"
                    id="name"
                    className="rounded-md w-full border border-gray-300 px-2 py-[5px] outline-1 outline-[#0086fe]"
...

              {
                ...
                discountOn == "BxGy" && (
                  <div className="bg-white p-5 rounded-xl border border-[#d5ddda] shadow-md">
                    ...
                    <RadioGroup
                      defaultValue={BxGyType}
                      onChange={(e) => {
                        setBxGyType(e.target.value);
                        setMinPhrReqValue(0);
                      }}
                    ...
                    >
                      ...
                      <div className="space-y-3 mt-2">
                        <div className="grid grid-cols-3 gap-3 justify-center items-center">
                          <div className="w-full space-y-1 md:max-w-full lg:max-w-md">
                            <span>{BxGyType == "buys" ? "Quantity" : "Amount"}</span>
                            <input
                              value={BxGyCusBuyAmount}
                              onChange={(e) => setBxGyCusBuyAmount(e.target.value)}
                              required
                              min={0}
                              type="number"
                              name="name"
                          ...
                          <div className="col-span-2 !w-full space-y-1">
                            <span>Any items from</span>
                            <Select
                              defaultValue={selectCatOrProdBuy}
                              onChange={(selectedOptions) => {
                                setSelectCatOrProdBuy(selectedOptions);
                                setSelectCatOrProdBuyArray([]);
                              }}
                      ...
                      <div className="space-y-3">
                        <div className="grid grid-cols-3 gap-3 justify-center items-center">
                          <div className="w-full space-y-1 md:max-w-full lg:max-w-md">
                            <span>Quantity</span>
                            <input
                              value={BxGyCusGetAmount}
                              onChange={(e) => setBxGyCusGetAmount(e.target.value)}
                              required
                              min={0}
                              type="number"
                              name="name"
                          ...
                          <div className="col-span-2 !w-full space-y-1">
                            ...
                            <Select
                              ...
                              onChange={(selectedOptions) => {
                                setSelectCatOrProdGet(selectedOptions);
                                setSelectCatOrProdGetArray([]);
                              }}
                      ...
                      <div className="mt-5">
                        ...
                        <RadioGroup
                          defaultValue={BxGyDiscountedOption}
                          onChange={(e) => {
                            setBxGyDiscountedOption(e.target.value);
                          }}
                          aria-labelledby="demo-radio-buttons-group-label"
                          name="radio-buttons-group"
                        >
                          <FormControlLabel value="percentage" control={<Radio />} label="Percentage" />
                          {BxGyDiscountedOption == "percentage" && (
                            <div className="ml-7 space-y-1">
                              <input
                                defaultValue={BxGyDiscountedValue}
                                onBlur={(e) => setBxGyDiscountedValue(e.target.value)}
                                min={0}
                                type="number"
                                name=""
                                id="minPhrReqValue"
                                placeholder={`Enter value..`}
                                className="w-1/4 py-1 px-2 outline-1 outline-[#0086fe] border border-gray-300 rounded-md"
                              />
                            </div>
                          )}
                          <FormControlLabel value="amount" control={<Radio />} label="Amount off each" />
                          {BxGyDiscountedOption == "amount" && (
                            <div className="ml-7 space-y-1">
                              <input
                                defaultValue={BxGyDiscountedValue}
                                onBlur={(e) => setBxGyDiscountedValue(e.target.value)}
                      ...
                      <div>
                        <FormControlLabel
                          ...
                          control={
                            <Checkbox
                              defaultChecked={BxGyMaxUserOption}
                              defaultValue={BxGyMaxUserOption}
                              onChange={(e) => {
                                setBxGyMaxUserOption(e.target.checked);
                              }}
                            />
                          }
                        ...
                        {BxGyMaxUserOption && (
                          <div className="ml-7">
                            <input
                              defaultValue={BxGyMaxUserValue}
                              onBlur={(e) => setBxGyMaxUserValue(e.target.value)}
                              min={1}
                              type="number"
                              name=""
                              id="minPhrReqValue"
...

              {
                ...
                (discountOn == "AOffP" || discountOn == "AOffO") && (
                  <div className="bg-white p-5 rounded-xl border border-[#d5ddda] shadow-md">
                    {/* common field */}
                    <div className="flex items-center gap-2">
                      <div className="w-full space-y-1 md:max-w-full lg:max-w-md">
                      ...
                      <div className="w-full space-y-1 md:max-w-full lg:max-w-md">
                        ...
                        <input
                          defaultValue={disCategoryValue}
                          onChange={(e) => setDisCategoryValue(e.target.value)}
                          required
                          type="number"
                          name="Amount"
                          id="Amount"
                    ...
                    {discountOn == "AOffP" && (
                      <div className="mt-3 space-y-2">
                        ...
                        <Select
                          ...
                          onChange={(selectedOptions) => {
                            setSelectCatOrProd(selectedOptions);
                            setSelectCatOrProdArray([]);
                          }}
                          className="basic-single"
                          classNamePrefix="select"
                          placeholder="Select category / products"
                ...
                discountOn == "FS" && (
                  <div className="bg-white p-5 rounded-xl border border-[#d5ddda] shadow-md">
                    ...
                    <FormControlLabel
                      control={
                        <Checkbox
                          defaultChecked={shippingRateOPOption}
                          defaultValue={shippingRateOPOption}
                          onChange={(e) => {
                            setShippingRateOPOption(e.target.checked);
                          }}
                        />
                      }
                      label="Exclude shipping rates over a certain amount"
                    />
                    {shippingRateOPOption && (
                      <div className="ml-7 space-y-1">
                        <input
                          defaultValue={shippingRateOPValue}
                          onBlur={(e) => setShippingRateOPValue(e.target.value)}
                          min={0}
                          type="number"
                          name=""
                          id="shippingRateOPValue"
                          placeholder={`Enter amount..`}
                          className="w-1/4 py-1 px-2 outline-1 outline-[#0086fe] border border-gray-300 rounded-md"
                        />
                        <br />
                        <label className="text-sm text-gray-500" htmlFor="minPhrReqValue">
                          Over how much € discount code will apply.
                        </label>
                      </div>
                    )}
                  </div>
              ...
              <div className="bg-white p-5 rounded-xl border border-[#d5ddda] shadow-md">
                ...
                <RadioGroup
                  defaultValue={minPhrReqOption}
                  onChange={(e) => {
                    setMinPhrReqOption(e.target.value);
                    setMinPhrReqValue(0);
                  }}
                  aria-labelledby="demo-radio-buttons-group-label"
                  name="radio-buttons-group"
                >
                  ...
                  {minPhrReqOption == "amount" && (
                    <div className="ml-7 space-y-1">
                      <input
                        defaultValue={minPhrReqValue}
                        onBlur={(e) => setMinPhrReqValue(e.target.value)}
                        min={0}
                        type="number"
                        name=""
                        id="minPhrReqValue"
                        placeholder={`Enter ${minPhrReqOption}..`}
                        className="w-1/4 py-1 px-2 outline-1 outline-[#0086fe] border border-gray-300 rounded-md"
                      />
                      <br />
                      <label className="text-sm text-gray-500" htmlFor="minPhrReqValue">
                  ...
                  {minPhrReqOption == "items" && (
                    <div className="ml-7 space-y-1">
                      ...
                      />
                      <br />
                      <label className="text-sm text-gray-400" htmlFor="minPhrReqValue">
                        Applies only to selected collections.
                      </label>
                    </div>
                  )}
              ...
              <div className="bg-white p-5 rounded-xl border border-[#d5ddda] shadow-md">
                ...
                <RadioGroup
                  defaultValue={eligibilityOption}
                  onChange={(e) => {
                    setEligibilityOption(e.target.value);
                  }}
                  aria-labelledby="demo-radio-buttons-group-label"
                  name="radio-buttons-group"
                >
                ...
                {eligibilityOption == "specific" && (
                  <div className="ml-7 space-y-1 w-full">
                    <Select
                      defaultValue={eligibilityValue}
                    ...
                    />
                    <label className="text-sm" htmlFor="eligibilityValue">
                      Applies only to selected collections.
                    </label>
                  </div>
                )}
              ...
              <div className="bg-white p-5 rounded-xl border border-[#d5ddda] shadow-md">
                ...
                <div>
                  <FormControlLabel
                    control={
                      <Checkbox
                        checked={limitDisOption}
                        defaultValue={limitDisOption}
                        onChange={(e) => {
                          setLimitDisOption(e.target.checked);
                        }}
                      />
                    }
                ...
                {limitDisOption && (
                  <div className="ml-7">
                    <input
                      defaultValue={limitDisValue}
                      onBlur={(e) => setLimitDisValue(e.target.value || 0)}
                      min={1}
                      type="number"
                      name=""
                      id="minPhrReqValue"
                ...
                <div>
                  <FormControlLabel
                    defaultValue={limitDisOnePerUse}
                    control={
                      <Checkbox
                        checked={limitDisOnePerUse}
                        defaultValue={limitDisOnePerUse}
                        onChange={(e) => {
                          setLimitDisOnePerUse(e.target.checked);
                        }}
                      />
                    }
              ...
              <div className="bg-white p-5 rounded-xl border border-[#d5ddda] shadow-md space-y-2">
                ...
                <div className="w-full flex justify-center items-center gap-2">
                  <DatePicker
                    format="DD/MM/YYYY"
                    onChange={(newDate) => {
                      setStartDate({ year: newDate?.$y, month: newDate?.$M + 1, Day: newDate?.$D });
                    }}
                    label="Start date"
                    className="w-full"
                    defaultValue={dayjs(defaultDateTimeStart)}
                  />
                  <TimePicker
                    label="Start time (+06)"
                    className="w-full"
                    defaultValue={dayjs(defaultDateTimeStart)}
                    onChange={(newDate) => {
                      setStartTime({ hour: newDate?.$H, min: newDate?.$m });
                    }}
                  />
                </div>
                <FormControlLabel
                ...
                {isEndTime && (
                  <div className="w-full flex justify-center items-center gap-2 mt-3">
                    <DatePicker
                      ...
                      label="End date"
                      className="w-full"
                      defaultValue={dayjs(defaultDateTimeEnd)}
                      onChange={(newDate) => {
                        setEndDate({ year: newDate?.$y, month: newDate?.$M + 1, Day: newDate?.$D });
                      }}
                    />
                    <TimePicker
                      label="End time (+06)"
                      ...
                      defaultValue={dayjs(defaultDateTimeEnd)}
                      onChange={(newDate) => {
                        setEndTime({ hour: newDate?.$H, min: newDate?.$m });
                      }}
                    />
                  </div>
                )}
...
export default IDwiseDiscountPage;
